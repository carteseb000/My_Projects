...
var brick = new sprite(bricks, false);
var sand1 = new sprite(sand, false);
var shadow1 = new sprite(shadows, false);
...
function draw() {
  setInterval(function () {
    ...
    bullet.draw(player.x, player.y, 64, 64);
...
function movement(everything) {
  ...
  if (key.f) { bullet.x = pointer.x; bullet.y = pointer.y; }
}

//system
window.onload = function () {
  setInterval(main, 2500 / 60);
};
